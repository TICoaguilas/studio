...
// In-memory store
const users: User[] = [
    { id: '1', name: 'Alice Smith', isClockedIn: false },
    { id: '2', name: 'Bob Johnson', isClockedIn: false },
    { id: '3', name: 'Charlie Brown', isClockedIn: false },
    { id: '4', name: 'Diana Prince', isClockedIn: false },
    { id: '5', name: 'Ethan Hunt', isClockedIn: false },
];
